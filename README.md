...
| Woodward Avenue by NHM | [`woodward-avenue/`](woodward-avenue/) (live files in `woodward-avenue/site/`) | Its own domain, through Cloudflare Pages. See [`woodward-avenue/README.md`](woodward-avenue/README.md#hosting-on-its-own-domain) |
