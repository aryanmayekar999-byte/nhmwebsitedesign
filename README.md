...
| Woodward Avenue by NHM | [`woodward-avenue/`](woodward-avenue/) (live files in `woodward-avenue/site/`) | Cloudflare: `woodward-avenue.<account>.workers.dev`, configured by `wrangler.jsonc` (setup in [`woodward-avenue/README.md`](woodward-avenue/README.md#hosting)) |
